        ...
        <div class="col-4">
            <form>
                <div class="form-group">
                    <label for="r">Nová poloha guličky</label>
                ...
                <div class="form-check">              
                    <input class="form-check-input" type="checkbox" name="animation" id="animation">    
                    <label class="form-check-label" id="neviem" for="animation">Zobrazenie animácie</label>         
                </div>          
                ...
                <a type="submit" onclick="getDataForBall()" class="btn btn-primary float-left">Submit</a>
            </form>     
        </div>      
    </div>  
  </div>
